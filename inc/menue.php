...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark fixed-top p-md-2 bg-opacity-75 shadow">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" data-bs-target=".navbar-collapse.show" href="index.php">Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" data-bs-target=".navbar-collapse.show" href="create.php">New Item</a>
        </li>
        <!-- <li class="nav-item">
